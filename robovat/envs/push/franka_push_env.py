...
class FrankaPushEnv(franka_arm_env.ArmEnv):
    """Pushing task environment."""
    ...
    def __init__(self,
        ...
        super(FrankaPushEnv, self).__init__(
    ...
    def _reset(self):
        """Reset."""
        observations = super(FrankaPushEnv, self)._reset()
    ...
    def _reset_scene(self):
        ...
        super(FrankaPushEnv, self)._reset_scene()
    ...
    def step(self, action):
        ...
        See parent class.
        """
        observation, reward, done, info = super(FrankaPushEnv, self).step(action)
