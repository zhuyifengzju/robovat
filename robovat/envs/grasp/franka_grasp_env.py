...
from robovat.robots import franka
...
class FrankaGrasp4DofEnv(franka_arm_env.ArmEnv):
    """Top-down 4-DoF grasping environment."""
    ...
    def __init__(self,
        ...
        super(FrankaGrasp4DofEnv, self).__init__(
    ...
    def _create_reward_fns(self):
        ...
        return [
            GraspReward(
                name='grasp_reward',
                end_effector_name=franka.FrankaPandaSim.ARM_NAME,
    ...
    def _reset_scene(self):
        ...
        """
        super(FrankaGrasp4DofEnv, self)._reset_scene()
    ...
    def _reset_robot(self):
        ...
        """
        super(FrankaGrasp4DofEnv, self)._reset_robot()
